...
urlpatterns = [
    ...
    # ── Estados de Cuenta — string routes BEFORE <int:pk> ──
    ...
    path('api/estados/generar-inversionista/',   views.generar_estado_inversionista,  name='api-generar-estado-inversionista'),
